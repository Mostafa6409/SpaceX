...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                # dcc.RangeSlider(id = 'payload-mass', min = 0, max = 10000, 
                                # step = 1000, value=[spacex_df['Payload Mass (kg)'].min(), spacex_df['Payload Mass (kg)'].max()] ),
                                dcc.RangeSlider(
                                id='payload-slider',
...
def get_pie_chart(entered_site):
        ...
        # Filter dataframe for the selected site
            ...
            filtered_df,
            names='class',
            title=f'Success vs faliure for site {entered_site}')
        return fig
...
def get_scatter(selected_site, payload_range):
